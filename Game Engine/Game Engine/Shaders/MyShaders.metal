...
vertex RasterizerData basic_vertex_shader(const VertexIn vIn [[ stage_in ]],
                                          ...
                                          constant ModelConstants &modelConstans [[ buffer(2) ]]){
    
    RasterizerData rd;
    
    rd.position = sceneConstants.projectionMatrix * sceneConstants.viewMatrix * modelConstans.modelMatrix * float4(vIn.position, 1);
    rd.color = vIn.color;
